<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryEdit.aspx.cs" Inherits="Authorization.Web.Dictionary.DictionaryEdit" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="false" runat="server">
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        <f:DropDownList ID="ddlTypeName" runat="server" Label="字典类型" Required="true" ShowRedStar="true" TabIndex="0"></f:DropDownList>
                        <f:TextBox ID="tbxValue" runat="server" Label="值" Required="true" ShowRedStar="true" TabIndex="1">
                        </f:TextBox>
