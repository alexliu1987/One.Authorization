<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuTree.aspx.cs" Inherits="Authorization.Web.sys.Menu.MenuTree" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="true" runat="server">
            ...
            <Items>
                <f:Tree runat="server" ShowBorder="false" ShowHeader="false"
                    ID="trMenuTree" AutoScroll="true" EnableArrows="true">
                </f:Tree>
            </Items>
        </f:Panel>
    </form>
