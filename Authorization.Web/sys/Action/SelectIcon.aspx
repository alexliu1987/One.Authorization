<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectIcon.aspx.cs" Inherits="Authorization.Web.sys.Action.SelectIcon" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="Panel1" />
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false"   AutoScroll="true" runat="server">
            ...
            <Items>
                <f:RadioButtonList ID="rblMenuIcon" runat="server"  ColumnNumber="10">                   
                </f:RadioButtonList>
            </Items>
        </f:Panel>
    </form>
