<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppTree.aspx.cs" Inherits="Authorization.Web.sys.App.AppTree" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" AutoScroll="true" runat="server">
            ...
            <Items>
                <f:Tree runat="server" ShowBorder="false" ShowHeader="false"
                    ID="trAppTree" AutoScroll="true" EnableArrows="true">
                </f:Tree>
            </Items>
        </f:Panel>
    </form>
